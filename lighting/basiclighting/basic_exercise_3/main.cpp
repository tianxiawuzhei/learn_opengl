/*
 基础光照:练习3-在观察空间（而不是世界空间）中计算冯氏光照：参考解答。
...
int main()
{
    ...
    auto lightingShader = new Shader("./shader_res/shader_view.vs", "./shader_res/shader_lighting_view.fs");
...
//    glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(trans));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightPos = glm::vec3(glm::sin(currentFrame), glm::sin(currentFrame), 2.0f);
