...
https://learnopengl.com/code_viewer_gh.php?code=src/2.lighting/5.1.light_casters_directional/light_casters_directional.cpp
...
int main()
{
    ...
    auto lightingShader = new Shader("./shader_res/shader.vs", "./shader_res/shader_lighting_directional.fs");
